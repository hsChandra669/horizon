    ...
    <section class="content" id="productContent">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="#" class="small-box-footer" onclick="location.href='<%=request.getContextPath()%>/testreq'">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      ...
      <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><sup style="font-size: 20px">Display count Here</sup></h3>
            ...
            <a href="#" class="small-box-footer" onclick="location.href='<%=request.getContextPath()%>/service'">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">Company Status Graph</h3>
            ...
            <div class="box-footer no-border">
              <div class="row">
                ...
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Pending Requests</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center">
                  <input type="text" class="knob" data-readonly="true" value="30" data-width="60" data-height="60" data-fgColor="#39CCCC">

                  <div class="knob-label">Completed Requests</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
