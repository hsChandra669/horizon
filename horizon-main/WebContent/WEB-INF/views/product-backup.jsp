...
<spring:url value="/resources/zmycustomjs/common.js" var="commonjs" />
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li id="slidebarMenuProduct" class="menuclass"><a href="#"><i class="fa fa-link"></i> <span>Product</span></a></li>
        <li class="treeview">
...
<!--   ======================================================================================================================= -->
  <div class="content-wrapper">
    ...
    <section class="content" id="productContent">
    	...
    	<h3>product content should go here</h3>
