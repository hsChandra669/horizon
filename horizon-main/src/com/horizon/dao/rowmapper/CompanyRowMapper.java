...
public class CompanyRowMapper implements RowMapper<Company> {
	...
	@Override
	public Company mapRow(ResultSet rs, int rowNumb) throws SQLException {
		...
		company.setUserID(rs.getInt("CREATED_BY"));
		company.setCreateTS(String.valueOf(rs.getTimestamp("CREATED_ON")));
		company.setLastUpdateTS(String.valueOf(rs.getTimestamp("LAST_UPDATED_ON")));
