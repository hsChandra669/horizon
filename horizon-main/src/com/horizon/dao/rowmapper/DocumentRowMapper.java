...
public class DocumentRowMapper implements RowMapper<Document> {
	...
	@Override
	public Document mapRow(ResultSet rs, int rowNumb) throws SQLException {
		Document document = new Document();

		document.setDocumentID(rs.getInt("DOCUMENT_ID"));
		document.setDocumentName(rs.getString("DOCUMENT_NAME"));
		document.setMimeType(rs.getString("EXTENSION_TYPE"));
		document.setFileSize(rs.getInt("DOCUMENT_SIZE"));
		document.setLastUpdateTS(String.valueOf(rs.getTimestamp("LAST_UPDATED_ON")));
